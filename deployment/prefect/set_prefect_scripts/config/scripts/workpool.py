    ...
    "variables": {
      ...
      "properties": {
        ...
        "env": {
          ...
          "description": "Environment variables to set when starting a uc1_prefect run.",
          "type": "object",
        ...
        "command": {
          "title": "Command",
          "description": "The command to use when starting a uc1_prefect run. In most cases, this should be left blank and the command will be automatically generated by the worker.",
          "type": "string"
        },
        "namespace": {
          "title": "Namespace",
